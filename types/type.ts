...
export type RoutePath = 
  ...
  | '/dashboard/family'
  | '/dashboard/family/patient'
  | '/dashboard/family/consultations'
  | `/dashboard/family/consultation-room/${string}`
  | '/dashboard/family/consultation-room'
  | '/dashboard/family/messages'
  | '/dashboard/family/resources'
  | '/dashboard/family/payments'
  | '/dashboard/family/notifications'
  | '/dashboard/family/settings'
  // Care Coordinator Unified Routes
  | '/dashboard/coordinator'
  | '/dashboard/coordinator/patients'
  | `/dashboard/coordinator/patients/${string}`
  | '/dashboard/coordinator/consultations'
  | `/dashboard/coordinator/consultation/${string}`
  | '/dashboard/coordinator/consultation'
  | '/dashboard/coordinator/messages'
  | '/dashboard/coordinator/resources'
  | '/dashboard/coordinator/protocols'
  | '/dashboard/coordinator/follow-ups'
  | '/dashboard/coordinator/notifications'
