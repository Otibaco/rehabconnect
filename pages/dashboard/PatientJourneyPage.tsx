...
import { JourneyTimelineSkeleton } from '../../components/dashboard/ui/Skeleton';
    ...
    <div className="space-y-6">
      <div className="flex justify-end">
        ...
        >
          ...
          <span>{loading ? 'REFRESHING TIMELINE...' : 'REFRESH TIMELINE'}</span>
        </button>
      </div>

      {loading ? <JourneyTimelineSkeleton /> : <JourneyTimeline />}
    </div>
  );
};
