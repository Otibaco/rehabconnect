...
import { ClinicalResource } from '@/types/type';
import { MOCK_CLINICAL_RESOURCES, MOCK_COORDINATOR_PATIENTS } from '@/lib/data';
...
export const CoordinatorResourcesPage: React.FC = () => {
  ...
  const [selectedPatientId, setSelectedPatientId] = useState<string>(MOCK_COORDINATOR_PATIENTS[0].id);
              ...
              {prescribeSuccess ? (
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-1.5">
                    ...
                    >
                      {MOCK_COORDINATOR_PATIENTS.map((p) => (
