              ...
              <tbody className="divide-y divide-[var(--border)]">
                {MOCK_COORDINATOR_PATIENTS.map((p) => (
                  <tr key={p.id} className="hover:bg-[var(--background-tertiary)]/50 transition-colors">
                    ...
                    <td className="py-3.5 font-bold capitalize text-[var(--gold)]">{p.careStatus}</td>
                    <td className="py-3.5 text-[var(--foreground-subtle)]">{p.lastConsultation ?? 'Not assigned'}</td>
