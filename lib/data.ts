import { ChallengeCampaign, ClinicalResource, FAQItem, Professional, ResourceArticle, ServiceItem, RehabCentre, DirectMessage } from "@/types/type";
...
export const MOCK_COORDINATOR_PATIENTS = [
  ...
  },
  {
    ...
    age: 68,
    gender: 'Male',
    title: 'Patient (Family-Supported)',
    avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=400&q=80',
    email: 'david.okafor@example.com',
    phone: '+234 802 987 6543',
...
export const REHAB_CENTRES: RehabCentre[] = [
  {
    id: 'centre-1',
    name: 'HopeHaven Online Recovery & Wellness Suite',
    location: '100% Virtual Tele-Care Platform',
    accreditation: ['Telehealth Certified', 'Ministry of Health Licensed', 'ISO 9001:2015'],
    specialties: ['Comprehensive Virtual Substance Recovery', 'Dual Diagnosis Tele-Therapy', 'Executive Online Recovery Care'],
    image: 'https://images.unsplash.com/photo-1586773860418-d37222d8fce3?auto=format&fit=crop&q=80&w=1200',
    rating: 4.9,
    reviewsCount: 142,
    capacity: 'Unlimited Telehealth Capacity',
    description: 'A comprehensive virtual rehabilitation sanctuary providing evidence-based doctor consultations, cognitive behavioral video sessions, and digital wellness support from the comfort of your home.',
    features: ['24/7 On-Call Doctor Support', 'Secure 1-on-1 Video Encrypted Rooms', 'Guided Tele-Therapy Modules', 'Nutritional Digital Coaching', 'Virtual Support Circles'],
    verified: true,
    featured: true,
  },
  {
    id: 'centre-2',
    name: 'Apex Virtual Neuro & Spine Rehabilitation Program',
    location: '100% Online Telehealth Stream',
    accreditation: ['CARF Telehealth Verified', 'Orthopedic Telemedicine Certified'],
    specialties: ['Online Stroke Recovery', 'Virtual Spinal Rehabilitation', 'Remote Motor Skills Training'],
    image: 'https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?auto=format&fit=crop&q=80&w=1200',
    rating: 4.95,
    reviewsCount: 98,
    capacity: 'Global Online Access',
    description: 'State-of-the-art virtual neurological recovery program featuring live doctor-supervised movement therapy, AI-guided posture tracking, and neuro-psychology video sessions.',
    features: ['Live Video Biomechanical Analysis', 'Daily Guided Digital Exercise Regimens', 'Doctor Progress Tracking', 'Virtual Family Sync Sessions'],
    verified: true,
    featured: true,
  },
  {
    id: 'centre-3',
    name: 'Serenity Virtual Behavioral Health & Mind Sanctuary',
    location: '100% Online Telehealth Suite',
    accreditation: ['Psychiatric Tele-Health Verified', 'WHO Digital Health Standards Compliant'],
    specialties: ['Virtual Burnout & Trauma Recovery', 'Online Mood Management', 'Remote Young Adult Wellness'],
    image: 'https://images.unsplash.com/photo-1512917774080-9991f1c4c750?auto=format&fit=crop&q=80&w=1200',
    rating: 4.85,
    reviewsCount: 76,
    capacity: 'Online Cloud Care',
    description: 'Focusing on deep psychological restoration, trauma-informed tele-therapy, and personalized emotional regulation through secure online clinical channels.',
    features: ['1-on-1 Daily Doctor Counseling', 'Virtual EMDR Tele-Therapy', 'Digital Mindfulness Routines', 'Direct Doctor Messaging'],
    verified: true,
    featured: true,
  },
  {
    id: 'centre-4',
    name: 'Horizon Digital Physical & Cardiac Recovery Studio',
    location: '100% Virtual Tele-Physio Clinic',
    accreditation: ['Cardiac Telehealth Approved', 'Digital Clinical Excellence'],
    specialties: ['Post-Cardiac Virtual Rehab', 'Online Pulmonary Conditioning', 'Remote Sports Injury Therapy'],
    image: 'https://images.unsplash.com/photo-1579684385127-1ef15d508118?auto=format&fit=crop&q=80&w=1200',
    rating: 4.88,
    reviewsCount: 112,
    capacity: 'Online Interactive Studio',
    description: 'Comprehensive cardiovascular, respiratory, and musculoskeletal recovery using remote vitals monitoring, video movement corrections, and digital workout roadmaps.',
    features: ['Virtual Vitals Dashboard', 'Live Video Physical Therapy', 'Custom PDF Recovery Prescriptions', 'Flexible Online Scheduling'],
    verified: true,
  },
];
...
export const MOCK_DIRECT_MESSAGES: DirectMessage[] = [
  {
    ...
    senderRole: 'Doctor',
    receiverId: 'pat_1',
    text: 'Good morning Sarah! How did the knee mobility exercises feel after yesterday’s video session?',
  ...
  },
  {
    ...
    senderRole: 'Patient',
    receiverId: 'coord-1',
    text: 'Hi Dr. Okafor! The quad flexion felt much smoother, pain dropped from 5/10 to 2/10. I completed the 15-minute routine.',
  ...
  },
  {
    ...
    senderRole: 'Doctor',
    receiverId: 'pat_1',
    text: 'Wonderful progress. I’ve attached Week 3’s advanced resistance band guide. Keep up the great consistency!',
    timestamp: 'Today, 10:05 AM',
    attachment: {
      name: 'Week3-Resistance-Protocol.pdf',
      size: '2.4 MB',
      type: 'pdf',
    },
  },
